...
public class ListUser extends javax.swing.JFrame {
    ...
    public ListUser() {
     ...
     public void judul() {
        Object[] judul = { "ID Buku", "Judul ", "Pengarang", "Penerbit", "Tahun Terbit", "Qty" };
    ...
    public void connect() {
        try {
            ...
            while (rs.next()) {
                ...
                String tahun = rs.getString("thn_terbit");
                String stok = rs.getString("jumlah");
                String[] data = { id, judul, pengarang, penerbit, tahun, stok };
                tabModel.addRow(data);
            }

        } catch (SQLException e) {
            JOptionPane.showMessageDialog(this, "SQL Error" + e.getMessage(), "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
    
    // file:/C:/01_Privacy/SCHOOL/Semester%204%20(2023)/PBO/Code/Perpus_FP/src/main/java/image/image%201.png
    public void ScaleImage() {
        ...
        // ImageIcon icon = new ImageIcon("C:/01_Privacy/SCHOOL/Semester 4
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Buku", "Judul ", "Pengarang", "Penerbit", "Tahun Terbit", "Qty"
            }
        ) {
        ...
        jButton2.setBounds(690, 20, 90, 40);
...
private void background() {
        ...
        ImageIcon imageIcon = new ImageIcon(
                "C:/01_Privacy/SCHOOL/Semester 4 (2023)/PBO/Code/Perpus_FP/src/main/java/image/image 1.png");
